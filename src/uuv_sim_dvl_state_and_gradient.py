...
class DVLGradMap:
    def __init__(self):
        ...
        # Subscribers
        # Sonar
        self.sonar0Sub = rospy.Subscriber('/dvl/dvl_sonar0', Range, self.Sonar0CB)
        self.sonar1Sub = rospy.Subscriber('/dvl/dvl_sonar1', Range, self.Sonar1CB)
        self.sonar2Sub = rospy.Subscriber('/dvl/dvl_sonar2', Range, self.Sonar2CB)
        self.sonar3Sub = rospy.Subscriber('/dvl/dvl_sonar3', Range, self.Sonar3CB)
        # Model state
